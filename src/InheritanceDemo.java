...
public class InheritanceDemo {
    ...
    public static void main(String[] args) {
        ...
        Worker worker1 = new Worker("000001", "Patrick", "O'Shaughnessy", "Mr.", 2002, 16.00);
        Worker worker2 = new Worker("000002", "Josh", "Dickens", "Mr.", 2001, 21.50);
        Worker worker3 = new Worker("000003", "Max", "Star", "Mr.", 2001, 22.75);

        /* Salary workers
         */
        SalaryWorker salWorker1 = new SalaryWorker("000004", "Sarah", "Mark", "Mrs.", 2001, 24.00, 49920);
        SalaryWorker salWorker2 = new SalaryWorker("000005", "Jeff", "Bridges", "Mr.", 2002, 30.00, 624000);
        SalaryWorker salWorker3 = new SalaryWorker("000006", "Liz", "Newman", "Mrs.", 1999, 32.50, 72500);
